...
import FilterChart8 from "../components/FilterChart8";
    ...
    <div id="chart" className="px-5">
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-4">
        <div className="mt-10 bg-gray-200">
          ...
          <FilterChart8 surveyData={filteredSurveyData} />
        </div>
        <div className="mt-10 bg-gray-200">
          <h1 className="font-bold text-xl">BSCS</h1>
          <FilterChart8 surveyData={filterBSCS} />
        </div>
        <div className="mt-10 bg-gray-200">
          <h1 className="font-bold text-xl">BSED</h1>
          <FilterChart8 surveyData={filterBSED} />
        </div>
        <div className="mt-10 bg-gray-200">
          <h1 className="font-bold text-xl">BEED</h1>
          <FilterChart8 surveyData={filterBEED} />
        </div>
        <div className="mt-10 bg-gray-200">
          <h1 className="font-bold text-xl">BSSW</h1>
          <FilterChart8 surveyData={filterBSSW} />
        </div>
        <div className="mt-10 bg-gray-200">
          <h1 className="font-bold text-xl">BSPOLSCIE</h1>
          <FilterChart8 surveyData={filterBSPOLSCIE} />
        </div>
        <div className="mt-10 bg-gray-200">
          <h1 className="font-bold text-xl">BSCRIM</h1>
          <FilterChart8 surveyData={filterBSCRIM} />
        </div>
        <div className="mt-10 bg-gray-200">
          <h1 className="font-bold text-xl">AB FIL</h1>
          <FilterChart8 surveyData={filterabfil} />
        </div>
      </div>
    </div>
  );
